...
function refresh(){
 const sci=window.Progress?.data||{completed:[],xp:0,streak:0,badges:[]};
 ...
 set('homeSciencePct',sciencePct+'%');set('homeMathsPct',mathsPct+'%');set('homeTotalXP',String(sci.xp||0));set('homeStreak',String(sci.streak||0));
