(function(){
  ...
  const subjects = {
    science: {
      name: 'Science',
      hi: 'विज्ञान',
      title: 'Class 6 Science | कक्षा 6 विज्ञान Chapter-wise Learning, Practice & Tests',
      description: 'कक्षा 6 विज्ञान के chapter-wise lessons, आसान explanations, practice questions, quizzes, tests और revision resources।'
    },
    maths: {
      name: 'Maths',
      hi: 'गणित',
      title: 'Class 6 Maths | कक्षा 6 गणित Chapter-wise Learning, Practice & Tests',
      description: 'कक्षा 6 गणित के chapter-wise concepts, step-by-step examples, practice, challenge questions और tests।'
    },
    english: {
      name: 'English',
      hi: 'अंग्रेज़ी',
      title: 'Class 6 English | कक्षा 6 अंग्रेज़ी Grammar, Chapters & Practice',
      description: 'कक्षा 6 English के grammar topics, chapter-wise learning, translation, practice questions और tests।'
    },
    hindi: {
      name: 'Hindi',
      hi: 'हिंदी',
      title: 'Class 6 Hindi | कक्षा 6 हिंदी Grammar, Chapters & Practice',
      description: 'कक्षा 6 हिंदी के grammar, chapter-wise learning, writing practice, questions और tests।'
    },
    gk: {
      name: 'GK & Reasoning',
      hi: 'सामान्य ज्ञान और रीजनिंग',
      title: 'Class 6 GK & Reasoning | सामान्य ज्ञान, Questions & Challenges',
      description: 'कक्षा 6 GK और Reasoning के topic-wise questions, quizzes, challenges और practice।'
    },
    'social-science': {
      name: 'Social Science',
      hi: 'सामाजिक विज्ञान',
      title: 'Class 6 Social Science | कक्षा 6 सामाजिक विज्ञान Chapter-wise Learning',
      description: 'कक्षा 6 Social Science के History, Geography और Civics chapters, activities, maps, practice और tests।'
    }
  };
  ...
  if (subjectKey && subjects[subjectKey]) {
    ...
    description = subjects[subjectKey].description;
  ...
  addJsonLd('class6-seo-website-jsonld', {
    ...
    '@type':'WebSite',
    name:'Class 6 Learning Hub',
    url:new URL('./', location.href).href,
    inLanguage:['hi','en'],
    isAccessibleForFree:true,
    potentialAction:{'@type':'SearchAction',target:new URL('./?q={search_term_string}', location.href).href,'query-input':'required name=search_term_string'}
  });
  ...
  addJsonLd('class6-seo-page-jsonld', {
    ...
    inLanguage:'hi',
    isAccessibleForFree:true,
    isPartOf:{'@type':'WebSite',name:'Class 6 Learning Hub',url:new URL('./',location.href).href}
  });
  ...
  if (subjectKey) {
    addJsonLd('class6-seo-breadcrumb-jsonld', {
      ...
      '@type':'BreadcrumbList',
      itemListElement:[
        {'@type':'ListItem',position:1,name:'Class 6 Learning Hub',item:new URL('./',location.href).href},
  ...
  if (isHome && !document.getElementById('class6SeoIntro')) {
    ...
    section.id='class6SeoIntro';
    section.className='home-section class6-seo-intro';
    section.innerHTML = `
  ...
  // Improve dynamic chapter/topic pages after their JavaScript renders the real heading.
  ...
  improveFromHeading();
  window.addEventListener('load',improveFromHeading,{once:true});
  setTimeout(improveFromHeading,1200);
})();
