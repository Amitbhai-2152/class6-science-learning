...
assert.match(files.cloud, /OWNER_KEY = 'class6CloudOwnerV1'/);
assert.match(files.cloud, /let sessionUserId = null/);
assert.match(files.cloud, /let sessionFresh = false/);
...
assert.match(files.index, /js\/cloud-sync\.js\?v=3/);
assert.match(files.index, /js\/xp-cloud-sync\.js\?v=2/);
assert.match(files.index, /js\/home-streak-cloud-sync\.js\?v=2/);
assert.match(files.index, /js\/badge-cloud-sync\.js\?v=2/);
assert.match(files.index, /js\/subject-progress-cloud-sync\.js\?v=2/);
