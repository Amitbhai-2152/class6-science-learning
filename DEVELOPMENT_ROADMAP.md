...
- [ ] Audit all progress, XP, streak and cloud-sync entry points before migration
...
## Queue status
**Progress Engine v2 maintenance is now the active queue.** The existing quality-hardening tasks remain verified.
