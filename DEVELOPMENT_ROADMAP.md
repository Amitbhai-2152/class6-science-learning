...
## Queue status
**Progress Engine v2 maintenance is now the active queue.** The audit, canonical activity-date source, XP/progress consumer migration, and streak cloud hardening tasks are verified; three verification/migration tasks remain.
